...
class DAggerDiffusionUnetRobocasaHybridWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        # dagger loop
        dagger_hdf5_path = ''
        for dagger_ep_idx in range(cfg.dagger.n_rollouts):
            ...
            # run rollout
            dagger_hdf5_path = env_runner.run(policy, dagger_ep_idx, cfg.dagger.n_rollouts-1)
                
            print(f"DAgger rollout {dagger_ep_idx} completed, data saved to {dagger_hdf5_path}")
